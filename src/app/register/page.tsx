    ...
    <div className="flex flex-col gap-4">
      ...
      <form action={formAction} className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-2">
          ...
          <Input name="password" minLength={6} type="password" placeholder="••••••••" required className="h-12 rounded-none border-gray-300 focus-visible:ring-black focus-visible:border-black font-medium" />
        </div>

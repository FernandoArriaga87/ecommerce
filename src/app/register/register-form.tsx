    ...
    <div className="flex flex-col gap-4">
      ...
      <form action={formAction} className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-2">
          ...
          <Input name="name" type="text" placeholder="Ej. Carlos Mendoza" required className="h-12 rounded-none border-gray-300 focus-visible:ring-black focus-visible:border-black font-medium" />
        </div>
        <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          ...
          <Input name="password" minLength={8} type="password" placeholder="••••••••" required className="h-12 rounded-none border-gray-300 focus-visible:ring-black focus-visible:border-black font-medium" />
          <p className="text-[10px] text-gray-500 font-medium tracking-wide">Mínimo 8 caracteres, incluyendo al menos una letra y un número.</p>
        </div>
